...
<head>
	...
	<body>
		...
		<div class="row">
			...
			<form action="../PHP/insertarPeso.php" method="post" class="col-9" onsubmit="return validar(this)" name="formPeso" style="width: 700px;">
	          <h1 class="sign-up-title">Llenar Todos Los Campos</h1>
	          <input type="number" class="sign-up-input" name="peso" value="" placeholder="Peso"/>
	          <label class="sign-up-input">Fecha:</label> 
	          <input type="date" class="sign-up-input" name="fecha_nue">
